    ...
    dz.on("complete", function (file) {
        ...
        $.post(url, {
            ...
            data = [
                {
                    class: "viral_kohli",
                    classification_probability: [1.05, 12.67, 22.00, 4.5, 91.56],
                    class_dictionary: {
                        lionel_messi: 0,
                        maria_sharapova: 1,
                        roger_federer: 2,
                ...
                {
                    class: "roder_federer",
                    classification_probability: [7.02, 23.7, 52.00, 6.1, 1.62],
                    class_dictionary: {
                        lionel_messi: 0,
                        maria_sharapova: 1,
                        roger_federer: 2,
            ...
            */
            ...
            let players = ["Cristiano_Ronaldo", "Karim_Benzema", "Lionel_Messi", "Luca_Modric", "Robert_Lewandowski"];
            ...
            if (match) {
                ...
                for(let personName in classDictionary) {
                    ...
                    let proabilityScore = match.classification_probability[index];
